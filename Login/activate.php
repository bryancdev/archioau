...
mysqli_select_db($con , $dbDatabase) or die("Couldn't connect to database $dbDatabase");
 ...
 $id =$_REQUEST['code'];
			mysqli_query($con, "UPDATE dbloantype SET dbstatus='Deactivate' WHERE code='$id' ")
			or die(mysqli_error()); 

$dateToday = date("m/d/Y");
      $sql2="INSERT INTO dbloanlog (`dbusername`,`date`,`dbaction`) VALUES ('$login_session','$dateToday','Deactivate Loan $id')";
