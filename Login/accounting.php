    ...
    <nav  class="navbar navbar-inverse" style = "background-color:#1f386e; border: 0px; border-radius: 0px">
      <div class="container-fluid">
        ...
        <li class="nav-item dropdown ">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">File Maintenance <i class="glyphicon glyphicon-cog"></i></a>
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                <a class="dropdown-item" href="list_of_members.php">Members Information</a>
                <br>
                <a class="dropdown-item" href="admin_loan.php">Loan Type</a>
                <br>
                
                <a class="dropdown-item" href="payment.php">Payment Type</a>
                <br>
                  ...
                  while($test = mysql_fetch_array($strSQL))
                    {
                      ...
                      echo"<tr>";
                      echo'<td  >'. $test['dbname'].'</td>';
                      $strSQL2 = mysql_query("SELECT FORMAT(SUM(dbdeposit),0) FROM dbdeposit where dbname= '$name'");
                      while($test = mysql_fetch_array($strSQL2))
                        {
                          echo "<td  ><center><span class='badge'>". $test['FORMAT(SUM(dbdeposit),0)']." Php</span></center></td>";
                        }   
                      echo "<td bgcolor='#F5F8F9'><center><a href='accounting.php?name=$name#addsavings_popup' class='btn btn-success btn-sm'><i class='glyphicon glyphicon-plus'></i> &nbsp ADD SAVINGS </a> &nbsp <a href='accounting.php?name=$name#savings_record_popup' class='btn btn-primary btn-sm'><i class='glyphicon glyphicon-list'></i> &nbsp SAVINGS RECORD</a></td>";                  
                       echo "</tr>";
                    }
                  ?>
                </tbody>
    ...
    <div id="savings_record_popup" class="overlay" >
      <div class="popup" style="  height: auto; height: 90% !important; width: 90%" >
        ...
        <div class="container-fluid bg-danger">
                ...
                <center><h4>Total: &nbsp&nbsp&nbsp <?php echo $deposits ;?> Php</h4></center></td>
        </div>
        </div>
    </div>   
<!--========================================================================-->
