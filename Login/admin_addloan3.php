    ...
    <?php
        ...
        if(strlen($query) >= $min_length)
                            { 
                                ...
                                $raw_results = mysqli_query($conn,"SELECT * FROM dbmember WHERE (`dbmemid` LIKE '%".$query."%')") or die(mysqli_error());
                                ...
                                if(mysqli_num_rows($raw_results) == 1){ 
                                    ...
                                    while($results = mysqli_fetch_array($raw_results))
                                    {
                                        ...
                                        $subsam = $results['subscription_amount'];
                                                   ...
                                                   $raw_results2 = mysqli_query($conn,"SELECT * FROM dbdeposit WHERE `mem_id` = '$id'") or die(mysqli_error());
                                                              ...
                                                              <h4 style="text-align: left">Loan Transaction</h4>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="border-left: 0px" colspan="2">';
                                                                        ...
                                                                        echo '<select class="form-control" name="cbcod" required>
                                                                            <option></option>
                                                                            ';
                                                                ...
                                                                echo '
                                                                 ...
                                                                 <tr style="border-bottom: 0px">
                                                                    <td style="border-right: 0px;border-bottom: 0px"><b>
                                                                        ...
                                                                        <input type="radio" id="loanba" onclick="loanablea()" name="loanable" value="b"> Amount to be loaned other than 80%
                                                                         </b></td>
                                                                ...
                                                                <tr id="lesscharges">
                                                                    <td style="border-right: 0px; border-top: 0px; border-left: 0px; text-align:right" ><b>Less Charges</b> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Service fee<br>Capital Build up 
                                                                    <td style="border-right: 0px; border-top: 0px; border-left: 0px; ">: <br> :</td>
                                                                    ...
                                                                    <input type="text" name="cb" id="cb" value="'.$c.'"  style="border: 0px; " readonly><u></u></td></td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    echo '
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td style="border-right: 0px; border-left: 0px">:</td>
                                                                            <td style="border-left: 0px" colspan="2">80% of Savings and Paid Share Capital<input type="text" name="ids" value="'.$ids.'" hidden></td>
                                                                        </tr>';
                                                                    echo'<tr>
                                                            ...
                                                            <center>';
                                                             ...
                                                             echo'
                                                                <div class="col-md-6">
                                                                    ...
                                                                    $result30 = mysqli_query($conn,"SELECT * FROM dbpayment WHERE `dbid` = '$ids'") or die(mysqli_error());
                                                                    ...
                                                                    if($num_rows30 > 0)
                                                                    {
                                                                        ...
                                                                        <tr>';
                                                                         ...
                                                                         $result32 = mysqli_query($conn,"SELECT SUM(dbpenalty) FROM dbpayment WHERE `dbid` = '$ids'"  ) or die(mysqli_error());
                                                                        ...
                                                                        $result31 = mysqli_query($conn,"SELECT SUM(dbamount) FROM dbpayment WHERE `dbid` = '$ids'") or die(mysqli_error());
        ...
        <div id="message" class="overlay" >
            ...
            <!--<?php $current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
                ...
                $res = mysqli_query($conn,"SELECT * FROM dbloan WHERE `id` = '$id'") or die(mysqli_error());
                $rows8 = mysqli_num_rows($res);
            ...
            <h3><center>Loan Payment Successfully Added!</center></h3>
        </div>
        </div>
         <div id="message2" class="overlay" >
            <div class="popup">
            <a class="close" href="#">&times;</a>
            <h3><center>Please input equal or higher than monthly amortization!</center></h3>
            </div>  
        </div>
           <div id="message3" class="overlay" >
            <div class="popup">
            <a class="close" href="#">&times;</a>
            <h3><center>Amount exceed the total amount to be paid!</center></h3>
            </div>  
        </div>
