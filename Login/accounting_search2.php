            ...
            <div class="col-md-4" >
              <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-search"></i></span>
                  <input type="text" name="search"  placeholder="Search" value="<?php echo htmlspecialchars($_REQUEST['name']); ?>" style=" width: 100%; height: 34px;
                                            padding: 6px 12px;
                                            font-size: 14px;
                  ...
                  <?php
                            ...
                            if(strlen($query) >= $min_length){ 
                                ...
                                $query = mysql_real_escape_string($query);
                                 ...
                                 $raw_results = mysql_query("SELECT FORMAT(SUM(dbdeposit),0), dbname FROM dbdeposit WHERE (`dbname` LIKE '%".$query."%') ORDER BY `id` ASC") or die(mysql_error());
                                ...
                                if(mysql_num_rows($raw_results) > 0){ 
                                    ...
                                    while($results = mysql_fetch_array($raw_results)){
                                        ...
                                        echo "<td  ><center><span class='badge'>". $results['FORMAT(SUM(dbdeposit),0)']." Php</span></center></td>";
                                        echo "<td bgcolor='#F5F8F9'><center><a href='accounting_search.php?name=$name#addsavings_popup' class='btn btn-success btn-sm'><i class='glyphicon glyphicon-plus'></i> &nbsp ADD SAVINGS </a> &nbsp <a href='accounting_search.php?name=$name#savings_record_popup' class='btn btn-primary btn-sm'><i class='glyphicon glyphicon-list'></i> &nbsp SAVINGS RECORD</a></td>";                  
